...
import { fetchCapacityReport } from "../api";
import PeriodComparison from "./PeriodComparison";

function MapView() {
  const [data, setData] = useState({ byDistrict: [], byRegion: [], byPeriod: [] });
  const [selectedDistrict, setSelectedDistrict] = useState(null);
  const [tooltip, setTooltip] = useState(null);

  useEffect(() => {
    fetchCapacityReport().then(setData);
  }, []);

  const getCapacity = (districtName) => {
    const d = data.byDistrict.find(
      (item) => item.name.toLowerCase() === districtName.toLowerCase()
    );
    return d ? d.capacity : 0;
  };

  const colorScale = (cap) => {
    if (cap > 400) return "#08306b";
    if (cap > 200) return "#2171b5";
    if (cap > 50) return "#6baed6";
    return "#cacacaff";
  };
  ...
  const handleClick = (e) => setSelectedDistrict(e.target.getAttribute("title"));
...
<svg
   ...
   ViewBox="29.573433 4.218628 35.033049 -1.482318"
   width="568.54413"
   height="593.63672">
  
  <path
     d="m 512.52486,325.56287 0,0 3.82,-0.47 -2.13,2.09 -1.02,1.86 -0.87,2.12 -0.54,2.22 -0.04,2.39 -2.34,-0.82 -9.55,0 -0.2,2.23 -1.83,0 0,-1.42 -6.87,0.09 1.71,-2.14 1.32,-2.43 2.49,-3.29 4.22,-1.22 3.29,-1.99 8.54,0.78 z"
     title="Bududa"
     id="UG-223"
     
      fill={colorScale(getCapacity("Bududa"))}
            stroke="#333"
            strokeWidth="0.5"
  ...
  <path
     ...
     id="UG-329"
      fill={colorScale(getCapacity("Nwoya"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 91.57486,470.05287 0,0 1.57,-0.31 0.82,-1.36 0.37,-1.38 1.09,-0.84 2.28,-0.47 1.95,0.78 -1.11,6.23 0.4,7.08 -3.09,2.98 0.31,3.49 -13.74,1.12 -1.23,3.67 -4.49,-1.63 -7.35,-4.08 -7.76,-2.05 0.81,-11.43 2.45,-2.05 4.91,-2.85 6.94,-1.64 4.2,-3.44 8.81,5.84 0.73,1.38 1.13,0.96 z"
     title="Buhweju"
     id="UG-325"
      fill={colorScale(getCapacity("Buhweju"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 75.63486,518.41287 0,0 -3.61,0.09 -3.01,-0.65 -2.27,-2.58 0.97,-3.8 -3.26,-5.72 8.57,-0.82 6.95,-0.82 1.22,-6.12 0,-6.95 1.23,-3.67 13.74,-1.12 -0.12,4.31 -2.3,7.63 -0.66,3.31 -1.59,3.94 -9.02,8.73 -6.84,4.24 z"
     title="Sheema"
     id="UG-425"
      fill={colorScale(getCapacity("Sheema"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 49.33486,496.76287 0,0 3.27,-0.81 3.27,0 2.45,2.45 0.82,3.26 1.22,2.86 4.09,1.23 3.26,5.72 -0.97,3.8 -3.16,-0.88 -2.54,2.03 -2.37,2.26 -2.77,-0.19 -2.59,0.45 -6.19,-4.5 -1.92,-4.48 -3,-3.44 -3.97,-1.99 -1.66,-3.9 1.39,-0.8 1.58,-0.59 0.28,-1.51 1.22,-2.43 0.23,-2.9 4.39,3.14 3.67,1.22 z"
     title="Mitooma"
     id="UG-422"
      fill={colorScale(getCapacity("Mitooma"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-122" 
      fill={colorScale(getCapacity("Kalungu"))}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 215.92486,435.35287 0,0 2.92,-0.41 2.48,3.75 1.48,3.55 2.37,5.63 1.78,4.44 0.89,4.74 2.07,4.15 -0.59,2.37 -2.96,3.55 -11.85,0 -2.07,-9.47 -2.37,-12.15 -1.48,-7.56 4.31,-3.24 3.02,0.65 z"
     title="Bukomansimbi"
     id="UG-118" 
      fill={colorScale(getCapacity("Bukomansibi"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-230"  fill={colorScale(getCapacity("Namayingo"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 493.59486,278.76287 0,0 9.24,-1 4.55,3.01 3.27,4.29 -2.04,4.32 -4.92,2.22 -3.23,2.09 -2.65,2.74 -1.62,2.77 -0.5,3.12 2.02,2.22 10.68,4.29 7.01,3.85 2.7,2.64 -0.02,3.56 -3.12,-0.59 -4.22,-0.9 -5.12,-0.61 -2.71,-2.71 -7.83,-2.11 -9.27,-1.35 1.76,-2.51 1.22,-2.77 0.55,-2.88 0.95,-2.74 1.14,-5.55 -2.66,-5.1 -1.35,-1.74 -0.19,-2.48 0.2,-6.92 1.62,-0.51 1.62,-0.23 1.41,0.93 1.51,0.65 z"
     title="Bulambuli"
     id="UG-225" 
      fill={colorScale(getCapacity("Bulambuli"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 523.09486,276.60287 0,0 1.89,-0.11 4.87,2.97 4.57,2.8 6.35,9.84 -1.56,5.26 -3.33,4.25 -2.02,1 -2.19,0.34 -2.77,1.08 -2.55,1.65 -3.46,4.21 -2.29,5.02 -0.22,-7.77 2.41,-6.02 -0.3,-4.22 -3.62,-2.41 -6.62,-1.81 -3.64,-3.3 2.04,-4.32 -3.27,-4.29 -4.55,-3.01 5.78,0.2 7.24,-3.8 2.8,0.8 1.42,0.67 1.16,0.88 1.86,0.09 z"
     title="Kween"
     id="UG-228" 
      fill={colorScale(getCapacity("Kween"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-322" 
      fill={colorScale(getCapacity("Agago"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 409.10486,169.81287 0,0 5.95,-0.27 6.84,9.24 3.12,2.3 2.22,3.04 0.58,5.22 -1.98,4.79 -2.89,2.94 -3.54,-0.57 -3.11,-1.91 -3.24,-0.11 -2.74,1.83 -10.04,0 -1.52,-1.22 -5.17,-1.83 -7.91,-0.3 -4.87,-1.22 -2.13,-2.13 -1.52,-3.96 -4.56,-1.83 -3.96,0 -2.43,1.83 -4.87,0 -5.48,-1.22 3.35,-2.13 1.52,-3.35 0.26,-2.83 3.03,-3.68 4.18,-2.59 4.65,-1.92 2.06,-0.44 1.5,1.13 1.78,0.92 2.39,-0.82 1.67,0.13 1.67,0.5 4.39,-0.39 4.26,1.39 1.97,-1.07 1.72,-1.77 2.25,0.28 2.4,0.9 1.89,-0.83 1.63,-1.75 4.68,3.7 z"
     title="Otuke"
     id="UG-330"   fill={colorScale(getCapacity("Otuke"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-323" 
      fill={colorScale(getCapacity("Alebtong"))}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 339.97486,220.54287 0,0 -4.5,-1.4 -2.13,-1.82 -3.96,-0.31 -2.12,-1.82 -1.83,-2.14 -7.61,0 -5.22,-0.17 1.25,-2.56 1.86,-2.36 2.43,-1.9 -2.22,-12.27 4.12,-1.15 7.2,-9.25 4.39,0.2 4.51,1.49 3.65,-2.88 -1.58,5.89 -2.13,3.96 -1.52,3.95 2.43,3.35 2.63,5.58 1.9,3.09 -0.66,1.93 -0.89,10.59 z"
     title="Kole"
     id="UG-326" 
      fill={colorScale(getCapacity("Kole"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-121" 
      fill={colorScale(getCapacity("Gomba"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 268.72486,426.54287 0,0 -5.33,-0.89 -5.34,2.08 -3.85,4.14 -6.51,5.04 -7.31,3.7 -4.47,-5.09 -2.02,-0.89 5.21,-3.05 7.7,-3.26 5.03,-2.37 3.85,-5.04 6.82,-3.85 5.92,-1.48 1.67,-2.36 1.96,-0.15 7.33,0.44 3.56,-1.48 0.29,4.14 -2.07,2.08 -2.96,2.37 -5.04,3.26 -4.44,2.66 z"
     title="Butambala"
     id="UG-119"  fill={colorScale(getCapacity("Butambala"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 399.73486,408.35287 0,0 4.08,9.25 0.02,126.57 0,0.01 -15.95,0 -19.06,0 -19.05,0 -6.21,0 0,-0.01 0,-56.24 17.33,-32.79 6.71,-24.77 5.74,-9.44 4.23,-4.14 1.17,-4.33 0.75,-3.7 3.38,-2.63 4.98,-2.74 2.3,0.75 9.58,4.21 z"
     title="Buvuma"
     id="UG-120" 
      fill={colorScale(getCapacity("Buvuma"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-232"  fill={colorScale(getCapacity("Serere"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 447.25486,342.12287 0,0 -5.51,-1.03 -4.97,1.32 -3.75,-3.52 -1.19,-1.96 0.02,-5.03 -1.6,-1.67 -4.93,-3.59 8.01,0.08 7.23,-2.71 7.83,-3.61 5.12,-2.11 -0.6,3.01 -1.21,1.81 0.91,2.11 2.11,1.2 -1.51,2.11 -3.62,1.81 -1.8,2.41 -0.54,9.37 z"
     title="Kibuku"
     id="UG-227"  fill={colorScale(getCapacity("Kibuku"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 477.04486,323.85287 0,0 -1.71,4.77 -1.6,1.61 -2.16,0.23 -0.85,1.76 -6.24,4.08 -5.67,4.86 -5.62,2.18 -5.94,-1.22 0.54,-9.37 1.8,-2.41 3.62,-1.81 1.51,-2.11 -2.11,-1.2 -0.91,-2.11 1.21,-1.81 0.6,-3.01 8.13,-0.3 6.93,2.11 3.92,1.8 4.55,1.95 z"
     title="Budaka"
     id="UG-217"  fill={colorScale(getCapacity("Budaka"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 355.73486,286.47287 0,0 1.56,1.16 1.89,-0.36 1.76,0.62 5.69,2.9 3.65,2.57 3.05,3 7.77,1.01 8.31,1.4 4.68,-1.34 4.73,-0.24 1.51,1.65 1.28,2 1.03,3.78 2.87,1.21 -0.28,2.91 -0.86,2.61 -2.04,2.64 -1.41,2.97 -1.89,2.63 -1.55,2.71 0.18,1.56 -0.2,1.38 -2.75,2.27 -1.86,2.32 0.15,1.4 0.59,1.48 -1.28,2.61 -1.58,2.58 -0.34,3.72 -4.05,-1.94 -3.01,-3.01 -4.82,-3.92 -2.71,-0.9 -2.41,-1.81 -0.6,-4.52 -1.51,-4.22 -7.83,-3.61 -8.02,-0.84 -3.14,-5.12 -0.96,-3.37 -2.42,-2.88 -0.58,-2.13 -4.36,-4.87 -2.1,-4.5 -2.05,-7.68 15.91,0.17 z"
     title="Buyende"
     id="UG-226"  fill={colorScale(getCapacity("Buyende"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-229"  fill={colorScale(getCapacity("Luuka"))}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 485.81486,310.61287 0,0 -2.32,5.07 -3.64,3.1 -2.19,-0.41 -2.01,-1.12 -4.88,-1.26 -2.06,-1.15 -2.12,-0.76 -9.06,-1.87 -1.64,-2.07 3.64,-2.7 4.22,-2.41 -0.3,-6.02 0,-4.22 2.11,-1.81 3.01,-2.11 -0.6,-6.63 4.52,-2.71 6.32,-1.2 8.62,-2.41 -0.2,6.92 0.19,2.48 1.35,1.74 2.66,5.1 -1.14,5.55 -0.95,2.74 -0.55,2.88 -1.22,2.77 -1.76,2.51 z"
     title="Bukedea"
     id="UG-224"  fill={colorScale(getCapacity("Bukedea"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 452.69486,269.30287 0,0 -3.7,1.38 -2.11,3.62 0.91,9.94 -0.6,6.63 -3.92,1.51 -2.41,3.01 0.72,7.74 -3.11,0.57 -1.97,-1.64 -1.02,-1.74 -2.48,0.06 -15.34,1.02 1.17,-2.59 1.96,-2.27 1.21,-0.77 1.28,-0.11 1.27,-0.77 4.31,-2.13 5.05,-18.58 0.72,-2.66 1.19,-2.99 2.18,-1.67 3.24,0.58 2.57,-1.24 4.79,0.44 4.09,2.66 z"
     title="Ngora"
     id="UG-231"  fill={colorScale(getCapacity("Ngora"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-418"  fill={colorScale(getCapacity("Kiruhura"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 126.88486,502.81287 0,0 4.73,2.16 3.65,3.4 0.87,2.21 1.17,1.6 2.29,-0.52 2.26,-0.1 4.59,0.42 4.6,-0.11 4.38,-1.07 3.69,-3.03 4.93,2.95 4.22,3.92 1.9,2.47 0.94,2.95 -0.4,2.63 1.48,4.65 -1.84,2.37 1.39,2.22 2.38,1.57 2.16,2.15 0.74,2.65 0.43,2.61 1.98,2.12 1.08,1.14 0.01,0.01 -2.22,0 -19.05,0 -19.06,0 -6.72,0 -1.66,-0.81 -3.68,-0.93 -3.91,2.04 -3.95,1.25 -1.51,0.79 -3.72,3.93 -1.32,1.1 -2.51,-0.78 -2.27,-0.25 -5.25,0.48 -1.93,0.46 -1.26,0.09 -0.58,-0.27 -0.54,-0.58 -0.77,-0.51 -1.3,-0.12 -0.83,0.68 -0.13,0.12 -1.14,-0.35 0.23,-0.79 2.15,-3.4 1.54,-3.67 0.29,-1.67 0.7,-1.65 1.32,-1.24 2.11,-3 1.64,-0.6 2,-2.47 1.34,-2.7 0.13,-5.64 5.22,0.85 -0.07,-9.11 -0.42,-4.45 0.57,-1.94 -0.14,-1.95 0.82,-3.55 4.26,0.55 1.98,-0.35 2.21,-0.98 3.8,0.05 z"
     title="Isingiro"
     id="UG-417"  fill={colorScale(getCapacity("Isingiro"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-413"  fill={colorScale(getCapacity("Kamwenge"))}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 64.45486,408.95287 0,0 5.31,-0.41 2.86,2.04 2.59,1.84 -3.41,13.68 -3.06,21.99 -2.33,-0.39 -5.35,0 -13.36,10.26 -6.35,0.06 -11.21,-1.69 -7.76,-0.41 -8.31,-1.73 1.33,-7.78 1.56,-3.83 0.56,-1.96 -0.09,-1.99 -1.24,-4.54 0.15,-1.8 0.91,-2.81 4.58,-6.38 0.57,-1.17 1.23,0.48 0.76,0.66 0.71,0.28 1.03,-0.66 0.37,-0.8 3.33,-17.12 12.56,-0.73 11.03,-2.45 8.17,2.45 2.86,4.91 z"
     title="Kasese"
     id="UG-406"  fill={colorScale(getCapacity("Kasese"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 61.59486,483.28287 0,0 7.76,2.05 7.35,4.08 4.49,1.63 0,6.95 -1.22,6.12 -6.95,0.82 -8.57,0.82 -4.09,-1.23 -1.22,-2.86 -0.82,-3.26 -2.45,-2.45 -3.27,0 -3.27,0.81 -3.67,-1.22 -4.39,-3.14 0.34,-1.59 0.2,-2.63 -0.5,-2.22 -3,-4.31 3.26,-0.82 4.09,-2.45 4.08,-2.04 3.27,0.82 3.68,4.49 4.9,1.63 z"
     title="Bushenyi"
     id="UG-402"  fill={colorScale(getCapacity("Bushenyi"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-105"  fill={colorScale(getCapacity("Masaka"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 199.11486,502.67287 0,0 3.85,-1.78 0.89,-5.33 2.27,-2.17 3.95,-0.2 3.55,-1.77 2.37,-2.67 4.03,0.73 3.07,4.51 -0.91,2.71 0.81,2.71 -0.41,0.78 -0.71,0.69 -0.16,2.66 1.43,2.65 1.82,2.09 2.17,4.79 2.43,2.95 2.2,1.08 3.84,1.37 1.91,0.82 3.29,0.82 3.83,0.27 9.32,0 0,23.79 0,0.01 -18.51,0 -19.05,0 -19.05,0 -16.83,0 -0.01,-0.01 -1.08,-1.14 -1.98,-2.12 -0.43,-2.61 -0.74,-2.65 -2.16,-2.15 -2.38,-1.57 -1.39,-2.22 1.84,-2.37 -1.48,-4.65 0.4,-2.63 -0.94,-2.95 -1.9,-2.47 -4.22,-3.92 -4.93,-2.95 4.47,-8.13 1.76,-4.81 5.33,0.44 4.44,-0.89 0.87,-6.24 4.46,5.35 6.82,4.74 6.99,2.69 4.86,1.75 z"
     title="Rakai"
     id="UG-110"   fill={colorScale(getCapacity("Rakai"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 551.11486,219.89287 0,0 2,11.99 -5.5,0.5 -0.49,9 0,13.49 -1.5,10 -4,6.99 -5.49,3.5 -6.28,4.1 -4.87,-2.97 -1.89,0.11 -1.86,-0.09 -1.16,-0.88 -1.42,-0.67 -2.8,-0.8 -7.24,3.8 -5.78,-0.2 -9.24,1 -1.51,-0.65 -1.41,-0.93 -1.62,0.23 -1.62,0.51 0.5,-7.37 -1.01,-0.41 -1.36,-0.09 0.01,-33.67 4.11,0 5.99,-1 4,-1.5 0.99,-3.49 3.5,-2 5.99,-4 15.99,-1 2.99,-4.5 0.5,-36.99 12.43,-0.67 3.06,8.17 3.49,10 0.82,14.8 1.68,5.69 z"
     title="Nakapiripirit"
     id="UG-311"  fill={colorScale(getCapacity("Nakapiripirit"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-214"  fill={colorScale(getCapacity("Mayuge"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 472.37486,345.93287 0,0 -2.12,0.16 -1.74,0.96 -1.5,1.26 -1.81,0.72 -1.96,0.01 -1.9,0.24 -3.36,2.28 -2.42,3.27 -5.19,11.62 -0.09,1.23 -0.79,0.92 -1.44,-0.4 -1.44,-0.13 -1.56,-3.56 -1.48,-1 -1.01,-0.95 -0.8,-3.3 -1.49,-3.54 -0.33,-3.65 0.16,-3.8 -0.87,-3.37 -2.46,-2.49 4.97,-1.32 5.51,1.03 5.94,1.22 5.62,-2.18 5.67,-4.86 6.24,-4.08 2.68,0.29 2.21,0.98 -0.49,1.97 -0.74,1.92 -0.32,4.47 -1.69,4.08 z"
     title="Butaleja"
     id="UG-219"  fill={colorScale(getCapacity("Butaleja"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-202"  fill={colorScale(getCapacity("Busia"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 434.96486,367.19287 0,0 1.95,-2.56 3.21,4.56 3.22,-0.1 3.27,-1.02 1.44,0.13 1.44,0.4 1.81,3.78 1.35,4.11 6.41,4.64 -0.87,1.71 -1.94,0.39 -3.68,4.99 -0.23,2.3 -3.55,2.09 -2.04,2.86 -1.02,4.49 -3.27,-0.2 -3.47,1.43 -3.68,2.65 -4.6,2.52 0.9,-4.86 -5.51,-1.27 -2.11,-2.71 -2.41,-1.51 1.24,-2.2 0.1,-1.16 -0.03,-1.14 -0.08,-4 0.91,-4.11 2.61,-2.86 1.97,-3.15 0.73,-4.15 -0.27,-4.16 -2.82,-2.81 -0.87,-2.71 3.32,1.78 3.46,1.44 3.11,0.41 z"
     title="Bugiri"
     id="UG-201"  fill={colorScale(getCapacity("Bugiri"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 511.74486,335.77287 0,0 -0.03,2.28 -0.61,2.13 -2.7,6.67 -3,3.9 -1.5,4.19 -1.78,1.62 -6.68,3.34 -0.86,0.92 -0.22,1.3 -0.05,-0.02 -6.89,-2.95 -6.86,-5.49 3.18,-2.97 1.03,-4.58 0.85,-2.29 1.3,-2.08 3.7,-1.78 -0.07,-1.92 0.4,-2.19 6.87,-0.09 0,1.42 1.83,0 0.2,-2.23 9.55,0 2.34,0.82 z"
     title="Manafwa"
     id="UG-221"  fill={colorScale(getCapacity("Manafwa"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-209"  fill={colorScale(getCapacity("Mbale"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 518.08486,318.88287 0,0 -1.74,6.21 -3.82,0.47 -8.54,-0.78 -3.29,1.99 -3.35,-1.31 -3.45,-0.83 -1.56,0.36 -1.45,-0.08 -1.51,-1.02 -1.66,-0.47 -1.56,-1.98 -1.25,-2.17 -2.68,0.52 -2.37,-1.01 3.64,-3.1 2.32,-5.07 9.27,1.35 7.83,2.11 2.71,2.71 5.12,0.61 4.22,0.9 3.12,0.59 z"
     title="Sironko"
     id="UG-215"  fill={colorScale(getCapacity("Sironko"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 544.78486,297.06287 0,0 0.2,1.96 1.81,4.23 1.08,4.15 -1.31,4.22 -3.31,1.51 -8.56,0.87 -2.16,1.33 -3.55,3.41 -5.05,1.15 -0.71,1.9 -0.17,2.35 -0.53,0.9 -0.59,1.01 -0.12,0.02 -0.01,-0.02 -0.28,-0.62 -1.17,-5.24 0.25,-5.28 2.29,-5.02 3.46,-4.21 2.55,-1.65 2.77,-1.08 2.19,-0.34 2.02,-1 3.33,-4.25 1.56,-5.26 3.95,4.9 0.06,0.06 z"
     title="Bukwa"
     id="UG-218"   fill={colorScale(getCapacity("Bukwa"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 520.60486,314.91287 0,0 -0.25,5.28 1.17,5.24 0.28,0.62 0.01,0.02 -2.05,0.39 -1.7,-0.96 -1.72,-0.41 1.74,-6.21 0.02,-3.56 -2.7,-2.64 -7.01,-3.85 -10.68,-4.29 -2.02,-2.22 0.5,-3.12 1.62,-2.77 2.65,-2.74 3.23,-2.09 4.92,-2.22 3.64,3.3 6.62,1.81 3.62,2.41 0.3,4.22 -2.41,6.02 0.22,7.77 z"
     title="Kapchorwa"
     id="UG-206"  fill={colorScale(getCapacity("Kapchorwa"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-318"  fill={colorScale(getCapacity("Dokolo"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 357.64486,177.07287 0,0 3.34,-0.95 -0.26,2.83 -1.52,3.35 -3.35,2.13 0,3.05 -2.73,3.04 -4.57,1.83 -0.61,2.44 4.57,0 3.65,1.21 1.52,3.66 3.95,3.04 3.96,2.13 2.13,3.66 0.67,16.27 -2.31,3.39 -3.14,0.88 -3.61,-1.87 -3.47,-2.25 -3.84,-0.71 -4.22,-0.32 -2.13,-0.81 -2.28,0.13 -1.82,-1.09 -1.6,-1.57 0.89,-10.59 0.66,-1.93 -1.9,-3.09 -2.63,-5.58 -2.43,-3.35 1.52,-3.95 2.13,-3.96 1.58,-5.89 1.24,-4.28 -4.96,-6.53 3.23,-2.42 1.65,-3.73 1.36,-0.04 1.18,1.61 1.97,0.92 2.48,0.28 1.96,1.24 2.76,0.92 1.4,5.18 2.08,0.23 1.5,1.49 z"
     title="Lira"
     id="UG-307"  fill={colorScale(getCapacity("Lira"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-103"   fill={colorScale(getCapacity("Kiboga"))}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 324.51486,409.91287 0,0 -5.91,-0.09 -6.26,1.53 -2.47,-3.08 2.25,-4.19 1.44,-1.83 0.63,-2.87 -0.17,-0.77 -0.7,-0.59 -0.12,-0.91 0.41,-0.75 -1.57,-1.28 -0.89,-1.3 1.37,-4.25 1.83,0.76 1.3,1.14 1.88,-0.14 1.57,-1.17 0.66,-1.85 2.03,-0.59 2.23,-0.26 1.26,2.25 -0.51,2.32 -0.38,3.49 0.48,3.44 1.92,6.1 -2.28,4.89 z"
     title="Kampala"
     id="UG-102"  fill={colorScale(getCapacity("Kampala"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 150.01486,94.10287 0,0 1.32,-1.26 1.29,-0.81 4.29,2.84 -2.69,4.89 -0.73,5.36 -2.92,3.17 -4.38,2.93 -3.64,4.05 -11.25,-0.5 -4.61,-0.15 4.25,-12.77 1.86,-3.69 0.38,-0.24 1.25,-0.28 0.49,-0.25 0.33,-0.54 0.13,-1.09 0.19,-0.51 2.06,-3.55 3,-3.3 0.79,-1.15 2.61,2.77 2.74,2.53 3.24,1.55 z"
     title="Maracha"
     id="UG-320" fill={colorScale(getCapacity("Maracha"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     title="Mpigi"
     id="UG-106" fill={colorScale(getCapacity("Mpigi"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-210" fill={colorScale(getCapacity("Pallisa"))}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 362.75486,378.75287 0,0 -4.52,2.96 -0.33,5.04 1.68,5.88 2.85,4.03 -0.84,5.72 -4.53,4.87 -6.05,5.88 -2.86,5.21 -3.03,3.36 -0.16,3.53 -9.12,10.76 -17.49,20.82 -11.64,0 3.03,-4.03 4.67,-6.19 5.68,-7 -0.19,-13.67 1.21,-8.5 1.16,-4.42 2.24,-3.09 2.28,-4.89 -1.92,-6.1 -0.48,-3.44 0.38,-3.49 0.51,-2.32 -1.26,-2.25 1.16,-2.63 -0.05,-2.86 8.66,-3.24 2.04,-6.94 1.63,-10.2 0.42,-9.68 3.09,6.54 3.77,6.14 4.08,3.21 5.55,2.35 3.19,2.52 5.19,6.12 z"
     title="Mukono"
     id="UG-108" fill={colorScale(getCapacity("Mukono"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-211" fill={colorScale(getCapacity("Soroti"))}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 436.77486,342.41287 0,0 2.46,2.49 0.87,3.37 -0.16,3.8 0.33,3.65 1.49,3.54 0.8,3.3 1.01,0.95 1.48,1 1.56,3.56 -3.27,1.02 -3.22,0.1 -3.21,-4.56 -1.95,2.56 -3.11,-0.41 -3.46,-1.44 -3.32,-1.78 -0.81,-4.12 -4.71,-1.92 -2.29,-0.65 -1.39,-1.87 -1.07,-6.84 4.62,-11.73 1.75,-2.11 1.29,-2.35 1.19,-2.77 1.67,-2.56 4.93,3.59 1.6,1.67 -0.02,5.03 1.19,1.96 3.75,3.52 z"
     title="Namutumba"
     id="UG-222" fill={colorScale(getCapacity("Namutumba"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-220" fill={colorScale(getCapacity("Kaliro"))}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 358.35486,261.29287 0,0 -1.08,5.32 -3.71,1.95 2.28,8.66 -0.11,9.25 -15.91,-0.17 -12.84,0.49 -9.05,0.81 -2.71,-2.65 -2.02,-3.37 -3.02,0.48 -2.12,-0.56 -3.2,-3.15 -2.26,-1.63 -2.53,-0.72 -4.73,-3.02 -6.89,-2.15 -1.55,-2.58 4.74,-0.69 18.32,0.26 7.32,0.08 3.61,-2.06 6.87,-6.35 8.11,-7.17 11.96,-0.69 10.52,9.66 z"
     title="Amolatar"
     id="UG-314" fill={colorScale(getCapacity("Amolatar"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
            ...
            style={{ cursor: "pointer" }}/>
  <path
     d="m 390.39486,341.62287 0,0 -0.01,3.78 -0.33,1.82 -0.65,1.72 -0.23,1.53 0.58,1.56 -0.36,1.23 -0.73,1 -0.42,2.39 -1.28,1.92 -1.46,0.83 -1.33,0.98 -0.79,1.69 -1.14,4.77 0.24,3.08 -2.37,-0.6 -1.73,-0.76 -2.49,0.55 -2.56,-0.19 -0.57,2.18 -3.22,-0.59 -2.28,1.47 -2.71,-1.16 0.18,-4.67 -0.47,-4.96 -1.31,-4.43 -2.01,-4.03 -4.97,-7.74 -1.26,-4.03 -1.9,-13.8 0.33,-2.24 2.25,-1.82 0.46,-2.03 0,-2.36 -0.42,-1.86 8.02,0.84 7.83,3.61 1.51,4.22 0.6,4.52 2.41,1.81 2.71,0.9 4.82,3.92 3.01,3.01 4.05,1.94 z"
     title="Kamuli"
     id="UG-205" fill={colorScale(getCapacity("Kamuli"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     id="UG-213" fill={colorScale(getCapacity("Kaberamaido"))}
            ...
            style={{ cursor: "pointer" }} />
  <path
     d="m 485.56486,270.05287 0,0 1.36,0.09 1.01,0.41 -0.5,7.37 -8.62,2.41 -6.32,1.2 -4.52,2.71 0.6,6.63 -3.01,2.11 -2.11,1.81 0,4.22 0.3,6.02 -4.22,2.41 -3.64,2.7 -1.97,-1.54 -2.89,-0.45 -2.74,-0.77 -2,-1.83 -1.83,-2.14 -2.88,-0.28 -0.72,-7.74 2.41,-3.01 3.92,-1.51 0.6,-6.63 -0.91,-9.94 2.11,-3.62 3.7,-1.38 5.09,1.58 5.19,-1.3 4.95,-0.68 17.64,1.15 z"
     title="Kumi"
     id="UG-208" fill={colorScale(getCapacity("Kumi"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
  ...
  <path
     ...
     title="Kalangala"
     id="UG-101" fill={colorScale(getCapacity("Kalangala"))}
            stroke="#333"
            strokeWidth="0.5"
            onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
   ...
   {/* Tooltip */}
        {tooltip && (
          <div
            className="absolute bg-white text-gray-800 text-sm px-3 py-2 rounded shadow-md border pointer-events-none"
            style={{ top: tooltip.y + 10, left: tooltip.x + 10 }}
          >
            <p className="m-0">
              <strong>Dname:</strong> {tooltip.name}
            </p>
            <p className="m-0">
              <strong>Capacity:</strong> {tooltip.capacity}
            </p>
          </div>
        )}
      </div>
